...
function handleBillAmountSubmit(e) {
    ...
    if(billAmountValue === ""  || parseInt(billAmountValue) === 0 || billAmountValue === null) {
...
function handleCashSubmit(e) {
    ...
    if ( cashAmountInput === "" || billAmountValue === "" ||parseInt(billAmountValue) === 0 || cashAmountInput === null || billAmountValue === null) {
      ...
      if (cash < bill) {
        ...
        displayErrorMessage(
          true,
          "Cash paid is less than bill. Please enter the right amount",
          sectionCashAmountInput
        );
      } else if (cash === bill) {
        displaySuccessMessage(
          true,
          "No amount should be returned.",
          sectionCashAmountInput
        );
      } else {
        displaySuccessMessage(false, "", sectionCashAmountInput);
